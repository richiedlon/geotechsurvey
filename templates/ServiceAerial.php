...
ga('send', 'pageview');
    ...
    <style>
        /* Banner Area */
        .banner_area {
          background: url("static/images/slider-2.jpg"); 
    </style>
        <!--Theme Styles CSS-->
...
{% include 'header.php' %}
    ...
    <section class="banner_area">
        <h2>AERIAL SURVEY DIVISION</h2>
        <ol class="breadcrumb">
            <li><a href="/">Home</a></li>
            <li><a href="#" class="active">Aerial Surveying</a></li>
        </ol>
    </section>
    <!-- End Banner area -->
    ...
    <section class="building_construction_area">
        <div class="container">
            <div class="row building_construction_row">
                <div class="col-md-8 constructing_laft">
                    <h2>AERIAL SURVEY DIVISION</h2>
                    <img src="static/images/aerialpage.png" alt="">
                    <a href="#">AERIAL SURVEY DIVISION</a>
                    <p>GeoTech features the next generation of geospatial solutions that encompass aerial photography, photogrammetry and geographic information systems. Our leadership team has a legacy of success in meeting and exceeding our clients' mission-critical needs that have rigorous mapping, CADD, GIS and orthophoto standards and specifications and this reflected in our high client retention rate along with a legion of satisfied customers.</p>

                    <p>GeoTech provides precision flight mission planning, flying and acquisition of aerial imagery to engineering firms, municipalities, government agencies, architects, surveyors and planners for both government and private sectors. We offer a full digital workflow option, from 3D flight planning all the way through to final delivery, eliminating film processing and scanning completely; in fact, this allows us to start working with aerial imagery that's hot off the runway.</p>
                    <div class="col-md-6 ipsum">
                        
                        <ul class="excavator">
                            <li><i class="fa fa-chevron-circle-right"></i>Aerial Imagery</li>
                            <li><i class="fa fa-chevron-circle-right"></i>3D modelling</li>
                            <li><i class="fa fa-chevron-circle-right"></i>Ortho photos</li>
                        </ul>
                    </div>
                    

                </div>
                <div class="col-md-4 constructing_right">
                    <h2>Quick Links</h2>
                    <ul class="painting">
                        <li><a href="ServiceArchitecture.php"><i class="fa fa-building" aria-hidden="true"></i>ARCHITECTURE</a></li>
                        <li><a href="ServiceConstruction.php"><i class="fa fa-gavel" aria-hidden="true"></i>CONSTRUCTION</a></li>
